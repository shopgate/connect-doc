...
| --- | --- | --- | --- | --- |
| item Shopgate_Model_Catalog_Product | uid | ✕ | Unique ID Note: Every item needs a unique item number (uid). If items have identical item numbers, they cannot be imported to Shopgate. | 5 |
...
| promotion Int | sort_order | ✔ | Promotion sort order; smallest value displayed first | 3 |
...
| age_rating Int |  | ✔ | Enter the items age classification. | 18 |
