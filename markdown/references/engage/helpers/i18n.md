...
The `i18n` object is being initialised during the app bootstrap process [when the dictionary is being prepared](/guides/technical/engage/using-the-translation-system#how-it-works) and passed to the `i18n` object.
...
For the example use case, we take a subscription from [How to Use Streams and Subscriptions guide](/guides/technical/engage/streams).
