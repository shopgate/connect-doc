...
If you have not read how the translation system works in Shopgate Engage, please read the guide for [Using Translation System](../../../guides/technical/engange/using-the-translation-system.md) first.
...
The `i18n` object is being initialised during the app bootstrap process [when the dictionary is being prepared](../../../guides/technical/engange/using-the-translation-system.md#how-it-works) and passed to the `i18n` object.
...
Since the app bootstrap process happens before everything else in Shopgate Engage, you must remember that `i18n` methods __MUST NOT__ be be used in the main scope of your module. `i18n` __MUST__ be used within a closure.

For the example use case, we take a subscription from [How to Use Streams and Subscriptions guide](../../../guides/technical/engange/streams.md).
...
## Related articles:
- [Using the translation system](../../../guides/technical/engange/using-the-translation-system.md)
